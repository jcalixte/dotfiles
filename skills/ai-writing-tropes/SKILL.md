---
description: Checklist of common AI writing tells to avoid when writing or editing prose — docs, READMEs, blog posts, PR descriptions, reports. Apply when producing or reviewing any human-facing prose.
---
...
When writing or editing prose, avoid the patterns below. Any one of them used once may be fine — the problem is when several appear together or one is used repeatedly. Write like a human: varied, imperfect, specific.
