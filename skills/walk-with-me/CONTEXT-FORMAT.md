...
- **`CONTEXT.md` is a glossary, not a design.** Goals, functions, components, performance budgets, and tradeoffs belong in `DESIGN.md` (see [DESIGN-FORMAT.md](../qfd/DESIGN-FORMAT.md)). When `DESIGN.md` names a term that needs defining, the definition lives here; never duplicate definitions across the two.
